...
architecture behave of synth_top_smo_io_s_axi is
    ...
    constant ADDR_KERNELTYPE_DATA_0 : INTEGER :=16#1a800#;
    constant ADDR_KERNELTYPE_CTRL : INTEGER :=16#1a804#;
    ...
    constant ADDR_SV_0_ID_HIGH : INTEGER :=16#0efff#;
    constant ADDR_SV_1_ID_BASE : INTEGER :=16#0f000#;
    constant ADDR_SV_1_ID_HIGH : INTEGER :=16#0ffff#;
    constant ADDR_SV_2_ID_BASE : INTEGER :=16#10000#;
    constant ADDR_SV_2_ID_HIGH : INTEGER :=16#10fff#;
    constant ADDR_SV_3_ID_BASE : INTEGER :=16#11000#;
    constant ADDR_SV_3_ID_HIGH : INTEGER :=16#11fff#;
    constant ADDR_SV_0_VALUE_BASE : INTEGER :=16#12000#;
    constant ADDR_SV_0_VALUE_HIGH : INTEGER :=16#13fff#;
    constant ADDR_SV_1_VALUE_BASE : INTEGER :=16#14000#;
    constant ADDR_SV_1_VALUE_HIGH : INTEGER :=16#15fff#;
    constant ADDR_SV_2_VALUE_BASE : INTEGER :=16#16000#;
    constant ADDR_SV_2_VALUE_HIGH : INTEGER :=16#17fff#;
    constant ADDR_SV_3_VALUE_BASE : INTEGER :=16#18000#;
    constant ADDR_SV_3_VALUE_HIGH : INTEGER :=16#19fff#;
    constant ADDR_LAMBDA_BASE : INTEGER :=16#1a000#;
    constant ADDR_LAMBDA_HIGH : INTEGER :=16#1a1ff#;
    constant ADDR_SVNONZEROFEATURE_BASE : INTEGER :=16#1a200#;
    constant ADDR_SVNONZEROFEATURE_HIGH : INTEGER :=16#1a2ff#;
    constant ADDR_NONZEROFEATURE_BASE : INTEGER :=16#1a300#;
    constant ADDR_NONZEROFEATURE_HIGH : INTEGER :=16#1a3ff#;
    constant ADDR_WEIGHT_BASE : INTEGER :=16#1a400#;
    constant ADDR_WEIGHT_HIGH : INTEGER :=16#1a5ff#;
    constant ADDR_OUTPUT_R_BASE : INTEGER :=16#1a600#;
    constant ADDR_OUTPUT_R_HIGH : INTEGER :=16#1a7ff#;
    ...
    signal int_sv_0_id_address0 : UNSIGNED(9 downto 0);
    ...
    signal int_sv_0_id_address1 : UNSIGNED(9 downto 0);
    ...
    signal int_sv_1_id_address0 : UNSIGNED(9 downto 0);
    ...
    signal int_sv_1_id_address1 : UNSIGNED(9 downto 0);
    ...
    signal int_sv_2_id_address0 : UNSIGNED(9 downto 0);
    ...
    signal int_sv_2_id_address1 : UNSIGNED(9 downto 0);
    ...
    signal int_sv_3_id_address0 : UNSIGNED(9 downto 0);
    ...
    signal int_sv_3_id_address1 : UNSIGNED(9 downto 0);
    ...
    signal int_sv_0_value_address0 : UNSIGNED(9 downto 0);
    ...
    signal int_sv_0_value_address1 : UNSIGNED(9 downto 0);
    ...
    signal int_sv_1_value_address0 : UNSIGNED(9 downto 0);
    ...
    signal int_sv_1_value_address1 : UNSIGNED(9 downto 0);
    ...
    signal int_sv_2_value_address0 : UNSIGNED(9 downto 0);
    ...
    signal int_sv_2_value_address1 : UNSIGNED(9 downto 0);
    ...
    signal int_sv_3_value_address0 : UNSIGNED(9 downto 0);
    ...
    signal int_sv_3_value_address1 : UNSIGNED(9 downto 0);
...
begin
    ...
    int_sv_0_id_address1 <= raddr(11 downto 2) when ar_hs = '1' else waddr(11 downto 2);
    ...
    int_sv_1_id_address1 <= raddr(11 downto 2) when ar_hs = '1' else waddr(11 downto 2);
    ...
    int_sv_2_id_address1 <= raddr(11 downto 2) when ar_hs = '1' else waddr(11 downto 2);
    ...
    int_sv_3_id_address1 <= raddr(11 downto 2) when ar_hs = '1' else waddr(11 downto 2);
    ...
    int_sv_0_value_address1 <= raddr(12 downto 3) when ar_hs = '1' else waddr(12 downto 3);
    ...
    int_sv_1_value_address1 <= raddr(12 downto 3) when ar_hs = '1' else waddr(12 downto 3);
    ...
    int_sv_2_value_address1 <= raddr(12 downto 3) when ar_hs = '1' else waddr(12 downto 3);
    ...
    int_sv_3_value_address1 <= raddr(12 downto 3) when ar_hs = '1' else waddr(12 downto 3);
