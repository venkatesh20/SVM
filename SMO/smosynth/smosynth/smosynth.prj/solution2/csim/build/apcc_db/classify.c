...
printf("\n\{ BEGIN @writeResult\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([16 x i8]* @aesl_internal_.str, i64 0, i64 0), i32 %%kernelType) nounwind, !dbg !9 for 0x%I64xth hint within @writeResult  --> \n", ++aesl_llvm_cbe_28_count);
...
llvm_cbe_tmp__4:
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = tail call i32 @classifyLinear([50 x %%struct.feature]* %%example, [50 x %%struct.feature]* %%sv, double* %%lambda, i32* %%svNonZeroFeature, i32* %%nonZeroFeature, double* %%weight, double* %%output, i32 1), !dbg !7 for 0x%I64xth hint within @writeResult  --> \n", ++aesl_llvm_cbe_31_count);
   /*tail*/ classifyLinear(llvm_cbe_example, llvm_cbe_sv, (double *)llvm_cbe_lambda, (signed int *)llvm_cbe_svNonZeroFeature, (signed int *)llvm_cbe_nonZeroFeature, (double *)llvm_cbe_weight, (double *)llvm_cbe_output, 1u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",1u);
...
llvm_cbe_tmp__7:
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = tail call i32 @classifyPoly([50 x %%struct.feature]* %%example, [50 x %%struct.feature]* %%sv, double* %%lambda, i32* %%svNonZeroFeature, i32* %%nonZeroFeature, double* %%weight, double* %%output, i32 1), !dbg !8 for 0x%I64xth hint within @writeResult  --> \n", ++aesl_llvm_cbe_37_count);
   /*tail*/ classifyPoly(llvm_cbe_example, llvm_cbe_sv, (double *)llvm_cbe_lambda, (signed int *)llvm_cbe_svNonZeroFeature, (signed int *)llvm_cbe_nonZeroFeature, (double *)llvm_cbe_weight, (double *)llvm_cbe_output, 1u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",1u);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%puts = tail call i32 @puts(i8* getelementptr inbounds ([29 x i8]* @aesl_internal_str2, i64 0, i64 0)), !dbg !10 for 0x%I64xth hint within @classifyLinear  --> \n", ++aesl_llvm_cbe_puts_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = getelementptr inbounds [50 x %%struct.feature]* %%example, i64 0, i64 0, !dbg !7 for 0x%I64xth hint within @classifyLinear  --> \n", ++aesl_llvm_cbe_68_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = sext i32 %%storemerge2 to i64, !dbg !7 for 0x%I64xth hint within @classifyLinear  --> \n", ++aesl_llvm_cbe_70_count);
  llvm_cbe_tmp__10 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge2);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = getelementptr inbounds i32* %%nonZeroFeature, i64 %%3, !dbg !7 for 0x%I64xth hint within @classifyLinear  --> \n", ++aesl_llvm_cbe_71_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = load i32* %%4, align 4, !dbg !7 for 0x%I64xth hint within @classifyLinear  --> \n", ++aesl_llvm_cbe_72_count);
  llvm_cbe_tmp__12 = (unsigned int )*llvm_cbe_tmp__11;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = tail call fastcc double @aesl_internal_wtDotProduct(double* %%weight, i32 %%5, %%struct.feature* %%1, i32 %%storemerge2), !dbg !7 for 0x%I64xth hint within @classifyLinear  --> \n", ++aesl_llvm_cbe_73_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = fptrunc double %%6 to float, !dbg !7 for 0x%I64xth hint within @classifyLinear  --> \n", ++aesl_llvm_cbe_74_count);
  llvm_cbe_tmp__14 = (float )((float )llvm_cbe_tmp__13);
if (AESL_DEBUG_TRACE)
printf("\n = %f,  0x%x\n", llvm_cbe_tmp__14, *(int*)(&llvm_cbe_tmp__14));
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = fpext float %%7 to double, !dbg !9 for 0x%I64xth hint within @classifyLinear  --> \n", ++aesl_llvm_cbe_77_count);
  llvm_cbe_tmp__15 = (double )((double )llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__15, *(long long*)(&llvm_cbe_tmp__15));
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = getelementptr inbounds double* %%output, i64 %%3, !dbg !9 for 0x%I64xth hint within @classifyLinear  --> \n", ++aesl_llvm_cbe_78_count);
  llvm_cbe_tmp__16 = (double *)(&llvm_cbe_output[(((signed long long )llvm_cbe_tmp__10))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__10));
}
if (AESL_DEBUG_TRACE)
printf("\n  store double %%8, double* %%9, align 8, !dbg !9 for 0x%I64xth hint within @classifyLinear  --> \n", ++aesl_llvm_cbe_79_count);
...
llvm_cbe_tmp__19:
if (AESL_DEBUG_TRACE)
printf("\n  %%puts1 = tail call i32 @puts(i8* getelementptr inbounds ([25 x i8]* @aesl_internal_str3, i64 0, i64 0)), !dbg !10 for 0x%I64xth hint within @classifyLinear  --> \n", ++aesl_llvm_cbe_puts1_count);
...
printf("\n\{ BEGIN @classifyPoly\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%puts = tail call i32 @puts(i8* getelementptr inbounds ([29 x i8]* @aesl_internal_str2, i64 0, i64 0)), !dbg !11 for 0x%I64xth hint within @classifyPoly  --> \n", ++aesl_llvm_cbe_puts_count);
   /*tail*/ puts(( char *)((&aesl_internal_str2[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 29
#endif
...
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = getelementptr inbounds [50 x %%struct.feature]* %%sv, i64 0, i64 0, !dbg !7 for 0x%I64xth hint within @classifyPoly  --> \n", ++aesl_llvm_cbe_139_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = getelementptr inbounds [50 x %%struct.feature]* %%example, i64 0, i64 0, !dbg !7 for 0x%I64xth hint within @classifyPoly  --> \n", ++aesl_llvm_cbe_140_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = sext i32 %%storemerge7 to i64, !dbg !9 for 0x%I64xth hint within @classifyPoly  --> \n", ++aesl_llvm_cbe_142_count);
  llvm_cbe_tmp__22 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge7);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__22);
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = getelementptr inbounds double* %%output, i64 %%4, !dbg !9 for 0x%I64xth hint within @classifyPoly  --> \n", ++aesl_llvm_cbe_143_count);
  llvm_cbe_tmp__23 = (double *)(&llvm_cbe_output[(((signed long long )llvm_cbe_tmp__22))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__22));
}
if (AESL_DEBUG_TRACE)
printf("\n  store double 0.000000e+00, double* %%5, align 8, !dbg !9 for 0x%I64xth hint within @classifyPoly  --> \n", ++aesl_llvm_cbe_144_count);
  *llvm_cbe_tmp__23 = 0x0p0;
if (AESL_DEBUG_TRACE)
printf("\n = %lf\n", 0x0p0);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = add nsw i32 %%storemerge7, 1, !dbg !10 for 0x%I64xth hint within @classifyPoly  --> \n", ++aesl_llvm_cbe_145_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = sext i32 %%storemerge16 to i64, !dbg !7 for 0x%I64xth hint within @classifyPoly  --> \n", ++aesl_llvm_cbe_161_count);
  llvm_cbe_tmp__25 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge16);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__25);
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = getelementptr inbounds i32* %%nonZeroFeature, i64 %%7, !dbg !7 for 0x%I64xth hint within @classifyPoly  --> \n", ++aesl_llvm_cbe_162_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = getelementptr inbounds double* %%output, i64 %%7, !dbg !8 for 0x%I64xth hint within @classifyPoly  --> \n", ++aesl_llvm_cbe_163_count);
...
llvm_cbe_tmp__52:
if (AESL_DEBUG_TRACE)
printf("\n  %%33 = add nsw i32 %%storemerge16, 1, !dbg !10 for 0x%I64xth hint within @classifyPoly  --> \n", ++aesl_llvm_cbe_200_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = sext i32 %%storemerge24 to i64, !dbg !7 for 0x%I64xth hint within @classifyPoly  --> \n", ++aesl_llvm_cbe_165_count);
  llvm_cbe_tmp__28 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge24);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__28);
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = getelementptr inbounds i32* %%svNonZeroFeature, i64 %%11, !dbg !7 for 0x%I64xth hint within @classifyPoly  --> \n", ++aesl_llvm_cbe_166_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = load i32* %%12, align 4, !dbg !7 for 0x%I64xth hint within @classifyPoly  --> \n", ++aesl_llvm_cbe_167_count);
  llvm_cbe_tmp__30 = (unsigned int )*llvm_cbe_tmp__29;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__30);
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = load i32* %%8, align 4, !dbg !7 for 0x%I64xth hint within @classifyPoly  --> \n", ++aesl_llvm_cbe_168_count);
  llvm_cbe_tmp__31 = (unsigned int )*llvm_cbe_tmp__26;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__31);
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = tail call fastcc double @aesl_internal_dotProduct(%%struct.feature* %%1, i32 %%13, i32 %%14, %%struct.feature* %%2, i32 %%storemerge24, i32 %%storemerge16), !dbg !7 for 0x%I64xth hint within @classifyPoly  --> \n", ++aesl_llvm_cbe_169_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = fptrunc double %%15 to float, !dbg !7 for 0x%I64xth hint within @classifyPoly  --> \n", ++aesl_llvm_cbe_170_count);
  llvm_cbe_tmp__33 = (float )((float )llvm_cbe_tmp__32);
if (AESL_DEBUG_TRACE)
printf("\n = %f,  0x%x\n", llvm_cbe_tmp__33, *(int*)(&llvm_cbe_tmp__33));
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = fadd float %%16, 1.000000e+00, !dbg !11 for 0x%I64xth hint within @classifyPoly  --> \n", ++aesl_llvm_cbe_173_count);
  llvm_cbe_tmp__34 = (float )((float )(llvm_cbe_tmp__33 + (*(float*)&FPConstant0)));
if (AESL_DEBUG_TRACE)
printf("\n = %f,  0x%x\n", llvm_cbe_tmp__34, *(int*)(&llvm_cbe_tmp__34));
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = fpext float %%17 to double, !dbg !11 for 0x%I64xth hint within @classifyPoly  --> \n", ++aesl_llvm_cbe_174_count);
  llvm_cbe_tmp__35 = (double )((double )llvm_cbe_tmp__34);
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__35, *(long long*)(&llvm_cbe_tmp__35));
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = tail call double @log(double %%18) nounwind, !dbg !11 for 0x%I64xth hint within @classifyPoly  --> \n", ++aesl_llvm_cbe_175_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = fptrunc double %%19 to float, !dbg !11 for 0x%I64xth hint within @classifyPoly  --> \n", ++aesl_llvm_cbe_176_count);
...
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__48&4294967295ull)));
  if (((llvm_cbe_tmp__48&4294967295U) == (51u&4294967295U))) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = sext i32 %%yindex to i64, !dbg !9 for 0x%I64xth hint within @aesl_internal_wtDotProduct  --> \n", ++aesl_llvm_cbe_255_count);
  llvm_cbe_tmp__54 = (unsigned long long )((signed long long )(signed int )llvm_cbe_yindex);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__54);
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = mul nsw i64 %%2, 50, !dbg !9 for 0x%I64xth hint within @aesl_internal_wtDotProduct  --> \n", ++aesl_llvm_cbe_256_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = sext i32 %%6 to i64, !dbg !9 for 0x%I64xth hint within @aesl_internal_wtDotProduct  --> \n", ++aesl_llvm_cbe_261_count);
  llvm_cbe_tmp__59 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__57);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__59);
if (AESL_DEBUG_TRACE)
printf("\n  %%.sum = add i64 %%8, %%3, !dbg !9 for 0x%I64xth hint within @aesl_internal_wtDotProduct  --> \n", ++aesl_llvm_cbe__2e_sum_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = getelementptr inbounds %%struct.feature* %%y, i64 %%.sum, i32 0, !dbg !9 for 0x%I64xth hint within @aesl_internal_wtDotProduct  --> \n", ++aesl_llvm_cbe_262_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = load i32* %%9, align 4, !dbg !9 for 0x%I64xth hint within @aesl_internal_wtDotProduct  --> \n", ++aesl_llvm_cbe_263_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = add nsw i32 %%6, 1, !dbg !11 for 0x%I64xth hint within @aesl_internal_wtDotProduct  --> \n", ++aesl_llvm_cbe_287_count);
...
llvm_cbe_tmp__76:
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = add nsw i32 %%6, 1, !dbg !11 for 0x%I64xth hint within @aesl_internal_wtDotProduct  --> \n", ++aesl_llvm_cbe_297_count);
...
llvm_cbe_tmp__77:
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = add nsw i32 %%5, 1, !dbg !11 for 0x%I64xth hint within @aesl_internal_wtDotProduct  --> \n", ++aesl_llvm_cbe_308_count);
...
llvm_cbe__2e_lr_2e_ph:
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = sext i32 %%xindex to i64, !dbg !8 for 0x%I64xth hint within @aesl_internal_dotProduct  --> \n", ++aesl_llvm_cbe_374_count);
  llvm_cbe_tmp__78 = (unsigned long long )((signed long long )(signed int )llvm_cbe_xindex);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__78);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = mul nsw i64 %%5, 50, !dbg !8 for 0x%I64xth hint within @aesl_internal_dotProduct  --> \n", ++aesl_llvm_cbe_375_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = sext i32 %%10 to i64, !dbg !8 for 0x%I64xth hint within @aesl_internal_dotProduct  --> \n", ++aesl_llvm_cbe_382_count);
  llvm_cbe_tmp__85 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__82);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__85);
if (AESL_DEBUG_TRACE)
printf("\n  %%.sum = add i64 %%13, %%6, !dbg !8 for 0x%I64xth hint within @aesl_internal_dotProduct  --> \n", ++aesl_llvm_cbe__2e_sum_count);
...
printf("\n.sum = 0x%I64X\n", ((unsigned long long )(llvm_cbe__2e_sum&18446744073709551615ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = getelementptr inbounds %%struct.feature* %%x, i64 %%.sum, i32 0, !dbg !8 for 0x%I64xth hint within @aesl_internal_dotProduct  --> \n", ++aesl_llvm_cbe_383_count);
  llvm_cbe_tmp__86 = (signed int *)(&llvm_cbe_x[(((signed long long )llvm_cbe__2e_sum))].field0);
if (AESL_DEBUG_TRACE) {
printf("\n.sum = 0x%I64X",((signed long long )llvm_cbe__2e_sum));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = load i32* %%14, align 4, !dbg !8 for 0x%I64xth hint within @aesl_internal_dotProduct  --> \n", ++aesl_llvm_cbe_384_count);
...
llvm_cbe_tmp__107:
if (AESL_DEBUG_TRACE)
printf("\n  %%38 = add nsw i32 %%10, 1, !dbg !11 for 0x%I64xth hint within @aesl_internal_dotProduct  --> \n", ++aesl_llvm_cbe_437_count);
