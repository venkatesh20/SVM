# 1 "C:/Users/Owner/Desktop/SVM/SMO/smosynth/smosynth/smoClassify.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/Owner/Desktop/SVM/SMO/smosynth/smosynth/smoClassify.c"
...
# 2 "C:/Users/Owner/Desktop/SVM/SMO/smosynth/smosynth/smoClassify.c" 2
...
# 3 "C:/Users/Owner/Desktop/SVM/SMO/smosynth/smosynth/smoClassify.c" 2
...
double output[50],
int kernelType);
# 4 "C:/Users/Owner/Desktop/SVM/SMO/smosynth/smosynth/smoClassify.c" 2
...
int main(int argc, char *argv[ ]) {
     ...
     FILE *modelIn, *dataIn, *out;
          ...
          char* mfile = "C:\\Users\\Owner\\Desktop\\SVM\\SMO\\smosynth\\smosynth\\poly_results\\model.dat";
           ...
           char* tfile = "C:\\Users\\Owner\\Desktop\\SVM\\SMO\\smosynth\\smosynth\\poly_results\\test.dat";
           ...
           char* pfile = "C:\\Users\\Owner\\Desktop\\SVM\\SMO\\smosynth\\smosynth\\poly_results\\pred.dat";
         ...
         if( !readData( dataIn, example, sv, lambda, svNonZeroFeature, nonZeroFeature, target, weight, output, zeroFeatureExample, rbfConstant, degree
          ...
          int ret=synth_top(example, sv, lambda, svNonZeroFeature, nonZeroFeature, weight, output, 1);
...
int diff_files(){
   ...
   int err_cnt=0;
   int cnt=0;
   fp1 = fopen("C:\\Users\\Owner\\Desktop\\SVM\\SMO\\smosynth\\smosynth\\poly_results\\pred.dat", "r");
   fp2 = fopen("C:\\Users\\Owner\\Desktop\\SVM\\SMO\\smosynth\\smosynth\\poly_results\\predpoly.dat", "r");

   if (fp1 == ((void *)0)) {
      printf("Cannot open %s for reading ","C:\\Users\\Owner\\Desktop\\SVM\\SMO\\smosynth\\smosynth\\poly_results\\pred.dat" );
      exit(1);
   } else if (fp2 == ((void *)0)) {
      printf("Cannot open %s for reading ", "C:\\Users\\Owner\\Desktop\\SVM\\SMO\\smosynth\\smosynth\\poly_results\\predpoly.dat");
      exit(1);
   } else {
