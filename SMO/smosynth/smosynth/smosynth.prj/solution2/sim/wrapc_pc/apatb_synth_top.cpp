...
extern "C" int synth_top (Feature example[50][50], Feature sv[50][50], double lambda[50], int svNonZeroFeature[50], int nonZeroFeature[50], double weight[49], double output[50], int kernelType);

#define synth_top AESL_ORIG_DUT_synth_top
extern "C" int synth_top (Feature example[50][50], Feature sv[50][50], double lambda[50], int svNonZeroFeature[50], int nonZeroFeature[50], double weight[49], double output[50], int kernelType);
#undef synth_top

int synth_top (Feature example[50][50], Feature sv[50][50], double lambda[50], int svNonZeroFeature[50], int nonZeroFeature[50], double weight[49], double output[50], int kernelType)
{
	...
	else
	{
		...
		sc_bv<32>* sv_0_id_tvin_wrapc_buffer = new sc_bv<32>[650];
		...
		tcl_file.set_num(650, &tcl_file.sv_0_id_depth);
		...
		sc_bv<32>* sv_1_id_tvin_wrapc_buffer = new sc_bv<32>[650];
		...
		tcl_file.set_num(650, &tcl_file.sv_1_id_depth);
		...
		sc_bv<32>* sv_2_id_tvin_wrapc_buffer = new sc_bv<32>[600];
		...
		tcl_file.set_num(600, &tcl_file.sv_2_id_depth);
		...
		sc_bv<32>* sv_3_id_tvin_wrapc_buffer = new sc_bv<32>[600];
		...
		tcl_file.set_num(600, &tcl_file.sv_3_id_depth);
		...
		sc_bv<64>* sv_0_value_tvin_wrapc_buffer = new sc_bv<64>[650];
		...
		tcl_file.set_num(650, &tcl_file.sv_0_value_depth);
		...
		sc_bv<64>* sv_1_value_tvin_wrapc_buffer = new sc_bv<64>[650];
		...
		tcl_file.set_num(650, &tcl_file.sv_1_value_depth);
		...
		sc_bv<64>* sv_2_value_tvin_wrapc_buffer = new sc_bv<64>[600];
		...
		tcl_file.set_num(600, &tcl_file.sv_2_value_depth);
		...
		sc_bv<64>* sv_3_value_tvin_wrapc_buffer = new sc_bv<64>[600];
		...
		tcl_file.set_num(600, &tcl_file.sv_3_value_depth);
		...
		sc_bv<64>* lambda_tvin_wrapc_buffer = new sc_bv<64>[50];
		...
		tcl_file.set_num(50, &tcl_file.lambda_depth);
		...
		sc_bv<32>* svNonZeroFeature_tvin_wrapc_buffer = new sc_bv<32>[50];
		...
		tcl_file.set_num(50, &tcl_file.svNonZeroFeature_depth);
