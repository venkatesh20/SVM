...
`define LENGTH_sv_0_id 650
`define LENGTH_sv_1_id 650
`define LENGTH_sv_2_id 600
`define LENGTH_sv_3_id 600
`define LENGTH_sv_0_value 650
`define LENGTH_sv_1_value 650
`define LENGTH_sv_2_value 600
`define LENGTH_sv_3_value 600
`define LENGTH_lambda 50
`define LENGTH_svNonZeroFeature 50
...
wire    [9 : 0]	arraysv_0_id_address0, arraysv_0_id_address1;
...
wire    [9 : 0]	arraysv_1_id_address0, arraysv_1_id_address1;
...
wire    [9 : 0]	arraysv_2_id_address0, arraysv_2_id_address1;
...
wire    [9 : 0]	arraysv_3_id_address0, arraysv_3_id_address1;
...
wire    [9 : 0]	arraysv_0_value_address0, arraysv_0_value_address1;
...
wire    [9 : 0]	arraysv_1_value_address0, arraysv_1_value_address1;
...
wire    [9 : 0]	arraysv_2_value_address0, arraysv_2_value_address1;
...
wire    [9 : 0]	arraysv_3_value_address0, arraysv_3_value_address1;
...
always @ (posedge AESL_clock or posedge AESL_reset) begin
    ...
    begin
        ...
        if ( AESL_mLatCnterIn_addr > AESL_mLatCnterOut_addr ) begin
          if ( AESL_clk_counter - AESL_mLatCnterIn[AESL_mLatCnterOut_addr] > 5 * 2280053 ) begin
