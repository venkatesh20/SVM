...
architecture behave of synth_top_smo_io_s_axi is
    ...
    constant ADDR_KERNELTYPE_DATA_0 : INTEGER :=16#11800#;
    constant ADDR_KERNELTYPE_CTRL : INTEGER :=16#11804#;
    ...
    constant ADDR_SV_0_ID_HIGH : INTEGER :=16#0e3ff#;
    constant ADDR_SV_1_ID_BASE : INTEGER :=16#0e400#;
    constant ADDR_SV_1_ID_HIGH : INTEGER :=16#0e7ff#;
    constant ADDR_SV_2_ID_BASE : INTEGER :=16#0e800#;
    constant ADDR_SV_2_ID_HIGH : INTEGER :=16#0ebff#;
    constant ADDR_SV_3_ID_BASE : INTEGER :=16#0ec00#;
    constant ADDR_SV_3_ID_HIGH : INTEGER :=16#0efff#;
    constant ADDR_SV_0_VALUE_BASE : INTEGER :=16#0f000#;
    constant ADDR_SV_0_VALUE_HIGH : INTEGER :=16#0f7ff#;
    constant ADDR_SV_1_VALUE_BASE : INTEGER :=16#0f800#;
    constant ADDR_SV_1_VALUE_HIGH : INTEGER :=16#0ffff#;
    constant ADDR_SV_2_VALUE_BASE : INTEGER :=16#10000#;
    constant ADDR_SV_2_VALUE_HIGH : INTEGER :=16#107ff#;
    constant ADDR_SV_3_VALUE_BASE : INTEGER :=16#10800#;
    constant ADDR_SV_3_VALUE_HIGH : INTEGER :=16#10fff#;
    constant ADDR_LAMBDA_BASE : INTEGER :=16#11000#;
    constant ADDR_LAMBDA_HIGH : INTEGER :=16#110ff#;
    constant ADDR_SVNONZEROFEATURE_BASE : INTEGER :=16#11100#;
    constant ADDR_SVNONZEROFEATURE_HIGH : INTEGER :=16#1117f#;
    constant ADDR_NONZEROFEATURE_BASE : INTEGER :=16#11200#;
    constant ADDR_NONZEROFEATURE_HIGH : INTEGER :=16#112ff#;
    constant ADDR_WEIGHT_BASE : INTEGER :=16#11400#;
    constant ADDR_WEIGHT_HIGH : INTEGER :=16#115ff#;
    constant ADDR_OUTPUT_R_BASE : INTEGER :=16#11600#;
    constant ADDR_OUTPUT_R_HIGH : INTEGER :=16#117ff#;
    ...
    signal int_sv_0_id_address0 : UNSIGNED(7 downto 0);
    ...
    signal int_sv_0_id_address1 : UNSIGNED(7 downto 0);
    ...
    signal int_sv_1_id_address0 : UNSIGNED(7 downto 0);
    ...
    signal int_sv_1_id_address1 : UNSIGNED(7 downto 0);
    ...
    signal int_sv_2_id_address0 : UNSIGNED(7 downto 0);
    ...
    signal int_sv_2_id_address1 : UNSIGNED(7 downto 0);
    ...
    signal int_sv_3_id_address0 : UNSIGNED(7 downto 0);
    ...
    signal int_sv_3_id_address1 : UNSIGNED(7 downto 0);
    ...
    signal int_sv_0_value_address0 : UNSIGNED(7 downto 0);
    ...
    signal int_sv_0_value_address1 : UNSIGNED(7 downto 0);
    ...
    signal int_sv_1_value_address0 : UNSIGNED(7 downto 0);
    ...
    signal int_sv_1_value_address1 : UNSIGNED(7 downto 0);
    ...
    signal int_sv_2_value_address0 : UNSIGNED(7 downto 0);
    ...
    signal int_sv_2_value_address1 : UNSIGNED(7 downto 0);
    ...
    signal int_sv_3_value_address0 : UNSIGNED(7 downto 0);
    ...
    signal int_sv_3_value_address1 : UNSIGNED(7 downto 0);
    ...
    signal int_lambda_address0 : UNSIGNED(4 downto 0);
    ...
    signal int_lambda_address1 : UNSIGNED(4 downto 0);
    ...
    signal int_svNonZeroFeature_address0 : UNSIGNED(4 downto 0);
    ...
    signal int_svNonZeroFeature_address1 : UNSIGNED(4 downto 0);
...
begin
    ...
    int_sv_0_id_address1 <= raddr(9 downto 2) when ar_hs = '1' else waddr(9 downto 2);
    ...
    int_sv_1_id_address1 <= raddr(9 downto 2) when ar_hs = '1' else waddr(9 downto 2);
    ...
    int_sv_2_id_address1 <= raddr(9 downto 2) when ar_hs = '1' else waddr(9 downto 2);
    ...
    int_sv_3_id_address1 <= raddr(9 downto 2) when ar_hs = '1' else waddr(9 downto 2);
    ...
    int_sv_0_value_address1 <= raddr(10 downto 3) when ar_hs = '1' else waddr(10 downto 3);
    ...
    int_sv_1_value_address1 <= raddr(10 downto 3) when ar_hs = '1' else waddr(10 downto 3);
    ...
    int_sv_2_value_address1 <= raddr(10 downto 3) when ar_hs = '1' else waddr(10 downto 3);
    ...
    int_sv_3_value_address1 <= raddr(10 downto 3) when ar_hs = '1' else waddr(10 downto 3);
    ...
    int_lambda_address1 <= raddr(7 downto 3) when ar_hs = '1' else waddr(7 downto 3);
    ...
    int_svNonZeroFeature_address1 <= raddr(6 downto 2) when ar_hs = '1' else waddr(6 downto 2);
