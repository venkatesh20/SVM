set moduleName synth_top_writeResult
...
set isOneStateSeq 0
set C_modelName {synth_top_writeResult}
...
set C_modelArgList { 
	...
	{ sv_0_id int 32 regular {array 221 { 1 } 1 1 }  }
	{ sv_1_id int 32 regular {array 221 { 1 } 1 1 }  }
	{ sv_2_id int 32 regular {array 204 { 1 } 1 1 }  }
	{ sv_3_id int 32 regular {array 204 { 1 } 1 1 }  }
	{ sv_0_value double 64 regular {array 221 { 1 } 1 1 }  }
	{ sv_1_value double 64 regular {array 221 { 1 } 1 1 }  }
	{ sv_2_value double 64 regular {array 204 { 1 } 1 1 }  }
	{ sv_3_value double 64 regular {array 204 { 1 } 1 1 }  }
	{ lambda double 64 regular {array 17 { 1 } 1 1 }  }
	{ svNonZeroFeature int 32 regular {array 17 { 1 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "example_0_id", "interface" : "memory", "bitwidth" : 32} , 
 	...
 	{ "Name" : "kernelType", "interface" : "wire", "bitwidth" : 32} ]}
...
set portList { 
	...
	{ weight_address0 sc_out sc_lv 6 signal 19 } 
	{ weight_ce0 sc_out sc_logic 1 signal 19 } 
	{ weight_q0 sc_in sc_lv 64 signal 19 } 
	{ output_r_address0 sc_out sc_lv 6 signal 20 } 
	{ output_r_ce0 sc_out sc_logic 1 signal 20 } 
	{ output_r_we0 sc_out sc_logic 1 signal 20 } 
	{ output_r_d0 sc_out sc_lv 64 signal 20 } 
	{ output_r_q0 sc_in sc_lv 64 signal 20 } 
	{ kernelType sc_in sc_lv 32 signal 21 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sv_0_id_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "sv_0_id", "role": "address0" }} , 
 	...
 	{ "name": "sv_1_id_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "sv_1_id", "role": "address0" }} , 
 	...
 	{ "name": "sv_2_id_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "sv_2_id", "role": "address0" }} , 
 	...
 	{ "name": "sv_3_id_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "sv_3_id", "role": "address0" }} , 
 	...
 	{ "name": "sv_0_value_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "sv_0_value", "role": "address0" }} , 
 	...
 	{ "name": "sv_1_value_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "sv_1_value", "role": "address0" }} , 
 	...
 	{ "name": "sv_2_value_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "sv_2_value", "role": "address0" }} , 
 	...
 	{ "name": "sv_3_value_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "sv_3_value", "role": "address0" }} , 
 	...
 	{ "name": "lambda_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "lambda", "role": "address0" }} , 
 	...
 	{ "name": "svNonZeroFeature_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "svNonZeroFeature", "role": "address0" }} , 
 	...
 	{ "name": "kernelType", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "kernelType", "role": "default" }}  ]}
set Spec2ImplPortList { 
	...
	sv_0_id { ap_memory {  { sv_0_id_address0 mem_address 1 8 }  { sv_0_id_ce0 mem_ce 1 1 }  { sv_0_id_q0 mem_dout 0 32 } } }
	sv_1_id { ap_memory {  { sv_1_id_address0 mem_address 1 8 }  { sv_1_id_ce0 mem_ce 1 1 }  { sv_1_id_q0 mem_dout 0 32 } } }
	sv_2_id { ap_memory {  { sv_2_id_address0 mem_address 1 8 }  { sv_2_id_ce0 mem_ce 1 1 }  { sv_2_id_q0 mem_dout 0 32 } } }
	sv_3_id { ap_memory {  { sv_3_id_address0 mem_address 1 8 }  { sv_3_id_ce0 mem_ce 1 1 }  { sv_3_id_q0 mem_dout 0 32 } } }
	sv_0_value { ap_memory {  { sv_0_value_address0 mem_address 1 8 }  { sv_0_value_ce0 mem_ce 1 1 }  { sv_0_value_q0 mem_dout 0 64 } } }
	sv_1_value { ap_memory {  { sv_1_value_address0 mem_address 1 8 }  { sv_1_value_ce0 mem_ce 1 1 }  { sv_1_value_q0 mem_dout 0 64 } } }
	sv_2_value { ap_memory {  { sv_2_value_address0 mem_address 1 8 }  { sv_2_value_ce0 mem_ce 1 1 }  { sv_2_value_q0 mem_dout 0 64 } } }
	sv_3_value { ap_memory {  { sv_3_value_address0 mem_address 1 8 }  { sv_3_value_ce0 mem_ce 1 1 }  { sv_3_value_q0 mem_dout 0 64 } } }
	lambda { ap_memory {  { lambda_address0 mem_address 1 5 }  { lambda_ce0 mem_ce 1 1 }  { lambda_q0 mem_dout 0 64 } } }
	svNonZeroFeature { ap_memory {  { svNonZeroFeature_address0 mem_address 1 5 }  { svNonZeroFeature_ce0 mem_ce 1 1 }  { svNonZeroFeature_q0 mem_dout 0 32 } } }
	...
	kernelType { ap_none {  { kernelType in_data 0 32 } } }
}
