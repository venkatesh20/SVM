...
module AESL_automem_svNonZeroFeature (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.synth_top.autotvin_svNonZeroFeature.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.synth_top.autotvout_svNonZeroFeature.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 5;
parameter DEPTH = 32'd 17;
