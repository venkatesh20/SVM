...
int diff_files();
void write_result(FILE *out, double output[4], double b);
void init_data(
Feature example[4][50],
Feature sv[17][50],
double lambda[17],
...
int main(int argc, char *argv[ ]) {
     ...
     FILE *modelIn, *dataIn, *out;
          ...
          char* mfile = "C:\\Users\\Owner\\Desktop\\SVM\\SMO\\smosynth\\smosynth\\rbf_results\\model.dat";
           ...
           char* tfile = "C:\\Users\\Owner\\Desktop\\SVM\\SMO\\smosynth\\smosynth\\rbf_results\\testmod.dat";
         ...
         if( !readData( dataIn, example, sv, lambda, svNonZeroFeature, nonZeroFeature, target, weight, output, zeroFeatureExample, rbfConstant, degree
          ...
          int ret=synth_top(example, sv, lambda, svNonZeroFeature, nonZeroFeature, weight, output, 2);
...
int diff_files(){
   ...
   fp2 = fopen("C:\\Users\\Owner\\Desktop\\SVM\\SMO\\smosynth\\smosynth\\rbf_results\\predrbfmod.dat", "r");

   if (fp1 == ((void *)0)) {
      printf("Cannot open %s for reading ","C:\\Users\\Owner\\Desktop\\SVM\\SMO\\smosynth\\smosynth\\rbf_results\\pred.dat" );
      exit(1);
   } else if (fp2 == ((void *)0)) {
      printf("Cannot open %s for reading ", "C:\\Users\\Owner\\Desktop\\SVM\\SMO\\smosynth\\smosynth\\rbf_results\\predrbfmod.dat");
      exit(1);
   } else {
      for (cnt=0; cnt<4; cnt++) {
      fscanf(fp1, "%f", &ch1);
