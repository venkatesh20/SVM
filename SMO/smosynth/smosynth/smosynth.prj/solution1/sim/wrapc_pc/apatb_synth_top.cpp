...
extern "C" int synth_top (Feature example[50][50], Feature sv[37][50], double lambda[37], int svNonZeroFeature[37], int nonZeroFeature[50], double weight[49], double output[50], int kernelType);

#define synth_top AESL_ORIG_DUT_synth_top
extern "C" int synth_top (Feature example[50][50], Feature sv[37][50], double lambda[37], int svNonZeroFeature[37], int nonZeroFeature[50], double weight[49], double output[50], int kernelType);
#undef synth_top

int synth_top (Feature example[50][50], Feature sv[37][50], double lambda[37], int svNonZeroFeature[37], int nonZeroFeature[50], double weight[49], double output[50], int kernelType)
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<64> *output_r_pc_buffer = new sc_bv<64>[50];
			int i = 0;
			...
			if (i > 0)
			{
				sc_lv<64>* output_lv0_0_49_1 = new sc_lv<64>[50];
				AESL_i = 0;
				for (int i_0 = 0; i_0 <= 49; i_0 += 1)
				{
					if (&(output[0]) != NULL)
					{
						output_lv0_0_49_1[0 + AESL_i].range(63, 0) = sc_bv<64>(output_r_pc_buffer[0 + AESL_i].range(63, 0));
					}
				...
				for (int i_0 = 0; i_0 <= 49; i_0 += 1)
				{
					...
					if (&(output[0]) != NULL)
					{
						*(long long*)&output[i_0] = (output_lv0_0_49_1[0 + AESL_i]).to_uint64();
					}
	...
	else
	{
		...
		sc_bv<32>* example_0_id_tvin_wrapc_buffer = new sc_bv<32>[650];
		...
		tcl_file.set_num(650, &tcl_file.example_0_id_depth);
		...
		sc_bv<32>* example_1_id_tvin_wrapc_buffer = new sc_bv<32>[650];
		...
		tcl_file.set_num(650, &tcl_file.example_1_id_depth);
		...
		sc_bv<32>* example_2_id_tvin_wrapc_buffer = new sc_bv<32>[600];
		...
		tcl_file.set_num(600, &tcl_file.example_2_id_depth);
		...
		sc_bv<32>* example_3_id_tvin_wrapc_buffer = new sc_bv<32>[600];
		...
		tcl_file.set_num(600, &tcl_file.example_3_id_depth);
		...
		sc_bv<64>* example_0_value_tvin_wrapc_buffer = new sc_bv<64>[650];
		...
		tcl_file.set_num(650, &tcl_file.example_0_value_depth);
		...
		sc_bv<64>* example_1_value_tvin_wrapc_buffer = new sc_bv<64>[650];
		...
		tcl_file.set_num(650, &tcl_file.example_1_value_depth);
		...
		sc_bv<64>* example_2_value_tvin_wrapc_buffer = new sc_bv<64>[600];
		...
		tcl_file.set_num(600, &tcl_file.example_2_value_depth);
		...
		sc_bv<64>* example_3_value_tvin_wrapc_buffer = new sc_bv<64>[600];
		...
		tcl_file.set_num(600, &tcl_file.example_3_value_depth);
		...
		sc_bv<32>* sv_0_id_tvin_wrapc_buffer = new sc_bv<32>[481];
		...
		tcl_file.set_num(481, &tcl_file.sv_0_id_depth);
		...
		sc_bv<32>* sv_1_id_tvin_wrapc_buffer = new sc_bv<32>[481];
		...
		tcl_file.set_num(481, &tcl_file.sv_1_id_depth);
		...
		sc_bv<32>* sv_2_id_tvin_wrapc_buffer = new sc_bv<32>[444];
		...
		tcl_file.set_num(444, &tcl_file.sv_2_id_depth);
		...
		sc_bv<32>* sv_3_id_tvin_wrapc_buffer = new sc_bv<32>[444];
		...
		tcl_file.set_num(444, &tcl_file.sv_3_id_depth);
		...
		sc_bv<64>* sv_0_value_tvin_wrapc_buffer = new sc_bv<64>[481];
		...
		tcl_file.set_num(481, &tcl_file.sv_0_value_depth);
		...
		sc_bv<64>* sv_1_value_tvin_wrapc_buffer = new sc_bv<64>[481];
		...
		tcl_file.set_num(481, &tcl_file.sv_1_value_depth);
		...
		sc_bv<64>* sv_2_value_tvin_wrapc_buffer = new sc_bv<64>[444];
		...
		tcl_file.set_num(444, &tcl_file.sv_2_value_depth);
		...
		sc_bv<64>* sv_3_value_tvin_wrapc_buffer = new sc_bv<64>[444];
		...
		tcl_file.set_num(444, &tcl_file.sv_3_value_depth);
		...
		sc_bv<64>* lambda_tvin_wrapc_buffer = new sc_bv<64>[37];
		...
		tcl_file.set_num(37, &tcl_file.lambda_depth);
		...
		sc_bv<32>* svNonZeroFeature_tvin_wrapc_buffer = new sc_bv<32>[37];
		...
		tcl_file.set_num(37, &tcl_file.svNonZeroFeature_depth);
		...
		sc_bv<32>* nonZeroFeature_tvin_wrapc_buffer = new sc_bv<32>[50];
		...
		tcl_file.set_num(50, &tcl_file.nonZeroFeature_depth);
		...
		sc_bv<64>* output_r_tvin_wrapc_buffer = new sc_bv<64>[50];
		...
		tcl_file.set_num(50, &tcl_file.output_r_depth);
...
// [call_c_dut] ---------->
		...
		sc_bv<64>* output_r_tvout_wrapc_buffer = new sc_bv<64>[50];
