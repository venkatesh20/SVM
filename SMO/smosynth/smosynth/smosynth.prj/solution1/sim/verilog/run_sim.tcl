...
if {[file isfile synth_top.autotvin.dat]} {
    file delete -force synth_top.autotvin.dat
}
if {[file isfile synth_top.autotvout.dat]} {
    file delete -force synth_top.autotvout.dat
}
