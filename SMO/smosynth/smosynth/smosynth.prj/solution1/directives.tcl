...
set_directive_inline "wtDotProduct"
...
set_directive_pipeline "classifyLinear/LINEAR_FOR_LOOP"
...
set_directive_loop_tripcount -min 1 -max 37 "classifyPoly/POLY_INNER_FOR_LOOP"
